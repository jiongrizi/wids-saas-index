<template>
  <div class="custom-edit-wrap sys-global-analysis-api-edit">
      ...
      <el-col :span="24">
        <el-row type="flex" class="row-bg" justify="space-between">
          ...
          <el-col :span="12" class="text-align-right">
            <a class="el-button el-button--primary is-plain" :href="'/#/sys-global-analysis-api'">返回</a>
          </el-col>
        </el-row>
      </el-col>
    </el-row>
...
export default {
  ...
  methods: {
    getData() {
      var t = this;
      var postUrl = "/sys/waf_get_sys_global_analysis_api";
    ...
    onClickWebRuleProSubmit(sysGlobalAnalysisApiForm) {
      ...
      var postUrl = "/sys/waf_edit_sys_global_analysis_api";
      if (t.type == 'new') {
        postUrl = "/sys/waf_create_sys_global_analysis_api";
      } else {
      ...
      this.$refs[sysGlobalAnalysisApiForm].validate((valid) => {
        if (valid) {
          ...
          JXAjax(
            ...
            function (response) {
              t.loading = false;
              window.location.href = '/#/sys-global-analysis-api/'
            },
            function () {
              t.loading = false;
            }
...
.sys-global-analysis-api-edit .longer-cascader .match-box-content {
