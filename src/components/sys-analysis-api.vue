    ...
    <el-row>
      <el-col :span="24">
        <el-row class="text-align-right">
          ...
          <a class="el-button el-button--primary" :href="'/#/sys-analysis-api-edit/new'">新建API</a>
        </el-row>
        <div class=" demo-block">
          ...
          " style="width: 100%">
            ...
            <el-table-column prop="suppression_conf" label="抑制参数配置"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleEdit(data) {
      window.location.href = "/#/sys-analysis-api-edit/" + data.api_name;
    },
    handleDelete(data) {
      var t = this;
      if (data.status == 'true') { 
      ...
      JXAjax(
        "post",
        "/sys/waf_delete_sys_analysis_api",
        {
