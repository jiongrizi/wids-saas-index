    ...
    <el-row>
      <el-col :span="24">
        <el-row class="text-align-right">
          ...
          <a class="el-button el-button--primary" :href="'/#/sys-action-api-edit/new'">新建API</a>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    handleEdit(data) {
      window.location.href = "/#/sys-action-api-edit/" + data.api_name;
    },
    handleDelete(data) {
      var t = this;
      if (data.status == 'true') { 
