...
export default {
  ...
  methods: {
    getData() {
      var t = this;
      var postUrl = "/sys/waf_get_wids_global_rule_check_list";
      var oData = {  };
      JXAjax(
        "post",
        postUrl,
    ...
    onClickDownloadRuleSubmit(downloadRuleForm) { 
      var t = this;
      var postUrl = "/sys/waf_load_wids_global_rule_check";
    ...
    handleDelete(data) {
      var t = this;
      t.loading = true;
      var postUrl = "/sys/waf_del_wids_global_rule_check";
      var oData = {
    ...
    onClickChangeOrderSubmit(index, value, operate) { 
      ...
      var postUrl = "/sys/waf_exchange_wids_global_rule_check_priority";
    ...
    onChangeRuleStatus(value) { 
      ...
      var postUrl = "/sys/waf_edit_wids_global_rule_check_status";
      JXAjax(
        "post",
        postUrl,
        oData,
