...
>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f
    ...
    handleDelete(data) {
      ...
      JXAjax(
        "post",
<<<<<<< HEAD
        "/sys/waf_delete_sys_web_analysis_component",
=======
        "/sys/waf_delete_sys_web_relate_component_check",
>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f
        { name: data.name },
        function (response) {
    ...
    onClickCreateSubmit(createForm) {
      ...
      var jsonObj = {};
<<<<<<< HEAD
      var postUrl = "/sys/waf_edit_sys_web_analysis_component";
      if (t.type == "new") { 
        postUrl = "/sys/waf_create_sys_web_analysis_component";
=======
      var postUrl = "/sys/waf_edit_sys_web_relate_component_check";
      if (t.type == "new") { 
        postUrl = "/sys/waf_create_sys_web_relate_component_check";
>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f
      }
      try  {
