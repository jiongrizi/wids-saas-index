...
<<<<<<< HEAD
<<<<<<<< HEAD:src/components/wids-web-name-list.vue
            <el-table-column prop="name_list_detail" label="名单描述"></el-table-column>
            <el-table-column prop="count" label="条目数量"></el-table-column>
========
            <el-table-column prop="name_list_detail" label="描述"></el-table-column>
            <el-table-column prop="name_list_item_count" label="条目数量">

            </el-table-column>
>>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f:src/components/name-list.vue
=======
            <el-table-column prop="name_list_detail" label="名单描述"></el-table-column>
            <el-table-column prop="count" label="条目数量"></el-table-column>
...
========
          <el-form-item label="加载名单" key="1" prop="name_list_uuid">
            <el-select v-model="downloadRuleForm.name_list_uuid" placeholder="请选择或输入模糊搜索" filterable>
              <el-option v-for="item in ruleOptions" :key="item.name_list_uuid" :label="item.name_list_name"
...
>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f
  ...
  methods: {
    getData() {
      var t = this;
<<<<<<< HEAD
      var postUrl = "/wids/waf_get_wids_web_name_list_list";
=======
      var postUrl = "/sys/waf_get_wids_web_name_list_list";
>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f
      var oData = {  };
      JXAjax(
        "post",
...
<<<<<<< HEAD
<<<<<<<< HEAD:src/components/wids-web-name-list.vue
      var postUrl = "/wids/waf_load_wids_web_name_list";
      var oData = { name_list_name: t.downloadRuleForm.name_list_name };
      
========
      var postUrl = "/waf/waf_load_name_list";
      var oData = { name_list_uuid: t.downloadRuleForm.name_list_uuid, domain: t.domain };
      if (t.ruleType == "group_rule") {
        postUrl = "/waf/waf_load_group_name_list";
        oData = { name_list_uuid: t.downloadRuleForm.name_list_uuid, group_id: t.domain };
      }
>>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f:src/components/name-list.vue
=======
      var postUrl = "/sys/waf_load_wids_web_name_list";
      var oData = { name_list_name: t.downloadRuleForm.name_list_name };
...
>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f
    ...
    handleDelete(data) {
      ...
      t.loading = true;
<<<<<<< HEAD
      var postUrl = "/wids/waf_del_wids_web_name_list";
=======
      var postUrl = "/sys/waf_del_wids_web_name_list";
>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f
      var oData = {
...
=======
      var postUrl = "/sys/waf_exchange_wids_web_name_list_priority";
>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f
...
<<<<<<< HEAD
      var postUrl = "/wids/waf_edit_wids_web_name_list_status";
=======
      var postUrl = "/sys/waf_edit_wids_web_name_list_status";
>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f
      JXAjax(
        "post",
        postUrl,
