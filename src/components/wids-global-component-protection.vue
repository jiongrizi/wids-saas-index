...
export default {
  ...
  methods: {
    getData() {
      var t = this;
      var postUrl = "/sys/waf_get_wids_global_component_protection_list";
      var oData = {  };
      JXAjax(
        "post",
        postUrl,
    ...
    onClickDownloadRuleSubmit(downloadRuleForm) { 
      var t = this;
      var postUrl = "/sys/waf_load_wids_global_component_protection";
    ...
    handleDelete(data) {
      var t = this;
      t.loading = true;
      var postUrl = "/sys/waf_del_wids_global_component_protection";
      var oData = {
        name: data.name
      };
    ...
    onClickChangeOrderSubmit(index, value, operate) { 
      ...
      var postUrl = "/sys/waf_exchange_wids_global_component_protection_priority";
    ...
    onChangeRuleStatus(value) { 
      ...
      var postUrl = "/sys/waf_edit_wids_global_component_protection_status";
      JXAjax(
        "post",
        postUrl,
        oData,
