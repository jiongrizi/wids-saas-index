...
export default {
  ...
  data() {
    return {
      ...
      isShowOrder: true,
      orderLoading: false,
      backUrl:"sys-global-relate-rule-check",
    };
  },
  ...
  methods: {
    getData() {
      var t = this;
      var postUrl = "/sys/waf_get_sys_global_relate_rule_check_list";
    ...
    onClickChangeOrderSubmit(index, value, operate) { 
      ...
      var postUrl = "/sys/waf_exchange_sys_global_relate_rule_check_priority";
