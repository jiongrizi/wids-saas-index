    ...
    <el-row type="flex" class="row-bg" justify="space-between">
      <el-col :span="24">
        <el-row type="flex" class="row-bg" justify="space-between">
          <el-col :span="12">
<<<<<<< HEAD
<<<<<<<< HEAD:src/components/wids-web-relate-rule-check.vue
            <h3>请求关联分析</h3>
========
            <h3>全局关联分析</h3>
>>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f:src/components/wids-global-relate-rule-check.vue
          </el-col>
...
<<<<<<< HEAD
<<<<<<<< HEAD:src/components/wids-web-relate-rule-check.vue
      var postUrl = "/wids/waf_get_wids_web_relate_rule_check_list";
========
      var postUrl = "/sys/waf_get_wids_global_relate_rule_check_list";
>>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f:src/components/wids-global-relate-rule-check.vue
      var oData = {};
...
<<<<<<< HEAD
<<<<<<<< HEAD:src/components/wids-web-relate-rule-check.vue
      var postUrl = "/wids/waf_load_wids_web_relate_rule_check";
========
      var postUrl = "/sys/waf_load_wids_global_relate_rule_check";
>>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f:src/components/wids-global-relate-rule-check.vue
=======
<<<<<<<< HEAD:src/components/wids-relate-component-check.vue
...
<<<<<<< HEAD
    ...
    handleDelete(data) {
      ...
      t.loading = true;
<<<<<<<< HEAD:src/components/wids-web-relate-rule-check.vue
      var postUrl = "/wids/waf_del_wids_web_relate_rule_check";
========
      var postUrl = "/sys/waf_del_wids_global_relate_rule_check";
>>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f:src/components/wids-global-relate-rule-check.vue
      var oData = {
...
<<<<<<<< HEAD:src/components/wids-web-relate-rule-check.vue
      var postUrl = "/wids/waf_exchange_wids_web_relate_rule_check_priority";
========
      var postUrl = "/sys/waf_exchange_wids_global_relate_rule_check_priority";
>>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f:src/components/wids-global-relate-rule-check.vue
...
<<<<<<<< HEAD:src/components/wids-web-relate-rule-check.vue
      var postUrl = "/wids/waf_edit_wids_web_relate_rule_check";
========
      var postUrl = "/sys/waf_edit_wids_global_relate_rule_check";
>>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f:src/components/wids-global-relate-rule-check.vue
