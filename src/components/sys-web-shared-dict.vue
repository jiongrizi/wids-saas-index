    ...
    <el-row>
      <el-col :span="24">
        <el-row class="text-align-right">
          ...
          <a class="el-button el-button--primary" :href="'/#/sys-web-shared-dict-edit/new'">新建共享字典</a>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    handleEdit(data) {
      window.location.href = "/#/sys-web-shared-dict-edit/" + data.shared_dict_name;
    },
    ...
    handleDelete(data) {
      ...
      JXAjax(
        "post",
        "/sys/waf_del_sys_web_shared_dict",
        {
