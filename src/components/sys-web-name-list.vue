    ...
    <el-row>
      <el-col :span="24">
        <el-row class="text-align-right">
          ...
          <a class="el-button el-button--primary" :href="'/#/sys-web-name-list-edit/new'">新建名单</a>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    handleEdit(data) {
      window.location.href = "/#/sys-web-name-list-edit/" + data.name_list_name;
    },
    handleLook(data) { 
      window.location.href = "/#/sys-web-name-list-item/" + data.name_list_name;
    },
    handleDelete(data) {
      var t = this;
      if (data.status == 'true') { 
