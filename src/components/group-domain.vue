  ...
  <el-row v-loading.fullscreen.lock="loadingPage">
    ...
    <el-dialog :title="domainTitle" v-model="dialogDomainFormVisible" width="520px" :close-on-click-modal="false"
      ...
      <el-form class="form-tag-dialog" :model="domainForm" size="mini" label-position="left" label-width="130px"
        ...
        <el-form-item label="网站" prop="domain" key="1">
          <el-input v-model="domainForm.domain" v-if="domainType == 'new'"
            placeholder="支持通配符，且为小写，支持统配符，例如_*.jxwaf.com"></el-input>
        ...
        <div v-if="domainForm.checkListProtocol.indexOf('HTTPS') > -1">
          <!-- <div> -->
          <el-form-item label="https强制跳转" key="4">
            <el-switch v-model="domainForm.redirect_https" active-value="true" inactive-value="false"></el-switch>
    ...
    handleEdit(data) {      
      ...
      JXAjax(
        ...
        function (response) {
          ...
          t.domainForm.redirect_https = oGetData.redirect_https;
