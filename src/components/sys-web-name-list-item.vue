...
export default {
  ...
  methods: {
    getData(nowPage) {
      ...
      JXAjax(
        "post",
        "/sys/waf_get_sys_web_name_list_item_list",
    ...
    onClickNameListItemSubmit(listItemForm) {
      var t = this;
      var postUrl = "/sys/waf_create_sys_web_name_list_item";
    ...
    onChangeSearch() { 
      ...
      if (t.dataSearch) {
        JXAjax(
          "post",
          "/sys/waf_search_sys_web_name_list_item",
    ...
    handleDelete(data) {
      ...
      JXAjax(
        "post",
        "/sys/waf_del_sys_web_name_list_item",
