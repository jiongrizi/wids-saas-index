      ...
      <el-col :span="24">
        <el-row type="flex" class="row-bg" justify="space-between">
          ...
          <el-col :span="12" class="text-align-right">
            <a class="el-button el-button--primary is-plain" :href="'/#/group-rule/' + uuid + '/sys-web-relate-rule-check'"
              v-if="ruleType == 'group_rule'">返回</a>
            <a class="el-button el-button--primary is-plain" :href="'/#/sys-web-relate-rule-check/' + ruleType" v-else>返回</a>
          </el-col>
        </el-row>
      </el-col>
    </el-row>
            ...
            <el-row type="flex" class="row-bg" justify="space-between">
              <el-col :span="12">
                <a class="el-button el-button--primary is-plain"
                  :href="'/#/group-rule/' + uuid + '/sys-web-relate-rule-check'" v-if="ruleType == 'group_rule'">返回</a>
                <a class="el-button el-button--primary is-plain" :href="'/#/sys-web-relate-rule-check/' + ruleType"
                  v-else>返回</a>
              </el-col>
              <el-col :span="12" class="text-align-right">
  ...
  data() {
    return {
      ...
      optionsMatchKey: [
        ...
        {
<<<<<<< HEAD
          value: 'base_component_result',
          label: 'base_component_result',

        }, 
        {
          value: 'analysis_component_result',
          label: 'analysis_component_result',
...
<<<<<<< HEAD
          if (node.label == "base_component_result") {
            var base_nodes = [];
            JXAjax(
              "post",
              "/sys/waf_get_sys_web_base_component_list",
              {},
              function (response) {
                var _data = response.data.message;
...
=======
          if (node.label == "component_result") { 
            ...
            JXAjax(
              "post",
              "/sys/waf_get_sys_web_component_protection_list",
              {},
              function (response) {
                var _data = response.data.message;
                if (_data.length > 0) {
...
<<<<<<< HEAD
          ...
          if (node.label == "analysis_component_result") {
            var analysis_nodes = [];
            JXAjax(
              "post",
...
>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f
          ...
          if (node.label == "relate_rule_result") { 
            ...
            var oData = { rule_type: ruleType };
            if (hash.indexOf("/group_rule/") > -1) { 
              ruleType = "group_rule"
              oData.rule_group_name = window.location.hash.split("/")[2]
            }
            JXAjax(
              "post",
<<<<<<< HEAD
              "/wids/waf_get_sys_web_relate_rule_check_list_all",
=======
              "/sys/waf_get_sys_web_relate_rule_check_list_all",
>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f
              oData,
              function (response) {
                var _data = response.data.message;
...
>>>>>>> 32b45c66599ebbe10939a1aaf64e015bf985a11f
      ...
      optionsOperator: [
        ...
        { value: "diff_gt", label: "与字典值相差大于" },
        { value: "diff_lt", label: "与字典值相差小于" },
        { value: "diff_eq", label: "与字典值相差等于" },
        { value: "diff_neq", label: "与字典值相差不等于" },
      ],
      optionsArgs: [
  ...
  methods: {
    getData() {
      var t = this;
      var postUrl = "/sys/waf_get_sys_web_relate_rule_check";
    ...
    onClickWebRuleProSubmit(webRuleManageForm) {
      ...
      var postUrl = "/sys/waf_edit_sys_web_relate_rule_check";
      if (t.type == 'new') {
        postUrl = "/sys/waf_create_sys_web_relate_rule_check";
        if (t.ruleType == "group_rule") { 
        ...
        if (valid) {
          ...
          JXAjax(
            ...
            function (response) {
              t.loading = false;
              if (t.ruleType == 'group_rule') {
                window.location.href = '/#/group-rule/' + t.uuid + '/sys-web-relate-rule-check';
              } else {
                window.location.href = '/#/sys-web-relate-rule-check/' + t.ruleType;
              }
