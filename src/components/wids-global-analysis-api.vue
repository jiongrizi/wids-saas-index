    ...
    <el-row v-loading.fullscreen.lock="loadingPage">
      <el-col :span="24">
        ...
        <div class="demo-block">
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="api_detail" label="API描述"></el-table-column>
            <el-table-column prop="api_website" label="API地址"></el-table-column>
      ...
      <el-dialog v-model="dialogDownloadRuleFormVisible" title="加载" :close-on-click-modal="false" width="520px"
        ...
        <el-form class="form-download-rule-dialog" :model="downloadRuleForm" label-position="left" label-width="130px"
          ...
          <el-form-item label="加载" key="1" prop="api_name">
            <el-select v-model="downloadRuleForm.api_name" placeholder="请选择或输入模糊搜索" filterable>
              <el-option v-for="item in ruleOptions" :key="item.api_name" :label="item.api_name" :value="item.api_name">
              </el-option>
            </el-select>
          </el-form-item>
        </el-form>
...
export default {
  ...
  methods: {
    getData() {
      var t = this;
      var postUrl = "/sys/waf_get_wids_global_analysis_api_list";
      var oData = {  };
      JXAjax(
        "post",
        postUrl,
    ...
    onClickDownloadRuleSubmit(downloadRuleForm) { 
      var t = this;
      var postUrl = "/sys/waf_load_wids_global_analysis_api";
      var oData = { api_name: t.downloadRuleForm.api_name };
    ...
    handleDelete(data) {
      var t = this;
      t.loading = true;
      var postUrl = "/sys/waf_del_wids_global_analysis_api";
      var oData = {
    ...
    onClickChangeOrderSubmit(index, value, operate) { 
      ...
      if (index > 0) { 
        ...
        if (operate == "up") {
          oData.type = "exchange";
          oData.exchange_name = t.tableData[index - 1].api_name;
        }
      }
      ...
      var postUrl = "/sys/waf_exchange_wids_global_analysis_api_priority";
    ...
    onChangeRuleStatus(value) { 
      ...
      var postUrl = "/sys/waf_edit_wids_global_analysis_api_status";
      JXAjax(
        "post",
        postUrl,
        oData,
